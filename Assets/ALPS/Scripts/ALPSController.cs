...
public class ALPSController : MonoBehaviour {
	...
	//Crosshairs
	public bool crosshairsEnabled = false;
	...
	public void Awake(){
		...
		head.transform.position = transform.position;
            ...
            head.AddComponent<KeyboardCamera>();
            head.AddComponent<GazeManager>();
            GameObject pipr = (GameObject) Instantiate(reticule, Vector3.zero, Quaternion.identity);
            pipr.transform.parent = head.transform;
            pipr.transform.localPosition = Vector3.zero;
